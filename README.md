...
Provides easy access to `sails-firebird` from Sails.js & Waterline.

This module is a Sails/Waterline community adapter.  Its goal is to provide a set of declarative interfaces, conventions, and best-practices for integrating with the sails-firebird database/service.
...
This sails-firebird adapter is available under the **MIT license**.
